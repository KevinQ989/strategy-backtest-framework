...
def test_get_date_valid(mock_price_dataframe):
    ...
    assert date_df.columns.tolist() == ['Open', 'High', 'Low', 'Close', 'Adj_Close', 'Volume']
    ...
    assert date_df.dtypes['Adj_Close'] == 'float64'
...
def test_get_ticker_valid(mock_price_dataframe):
    ...
    assert ticker_df.columns.tolist() == ['Open', 'High', 'Low', 'Close', 'Adj_Close', 'Volume']
    ...
    assert ticker_df.dtypes['Adj_Close'] == 'float64'
